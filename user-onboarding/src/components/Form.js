			...
			<Container>
				...
				<StyledForm onSubmit={(e) => handleSubmit(e)}>
					...
					<InputCombo className='input-combo'>
						...
						<VerticalSplitter className='vertical-splitter-left' style={{alignItems: 'flex-start'}}>
							<label for='id'>Name</label>
						</VerticalSplitter>

						<VerticalSplitter className='vertical-splitter-right' style={{alignItems:'flex-end'}}>
							<input
								id='name'
								name='name'
								type='text'
					...
					<InputCombo className='input-combo'>
							...
							<VerticalSplitter className='vertical-splitter-right' style={{alignItems:'flex-start'}}>
								<input
									id='terms'
									name='terms'
									type='checkbox'
					...
					<InputCombo id='submit-btn-input-combo'>
						<button style={{width: '300px', height: '30px'}}disabled={disabledButton}>Submit!</button>
					</InputCombo>
